...
var Hello = function(options) {
	...
	this._mediaConstraints = mediaConstraints;
	...
	socket.on('hello:offer', function(offer) {
		...
		peerConnection.createAnswer(createAnswer, function() {}, this._mediaConstraints);
	}.bind(this));
...
Hello.prototype.answer = function(uid, options) {
	...
	if (cid) {
		var onSuccessMedia = function(stream) {
			...
			}.bind(this), function() {}, this._mediaConstraints);
